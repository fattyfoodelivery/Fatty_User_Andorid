...
import com.joy.fattyfood.adapters.AddressAdapter
import com.joy.fattyfood.app.FattyApp
import com.joy.fattyfood.databinding.ActivityManageAddressBinding
    ...
    private fun setUpCustomerAddressList() {
        ...
        addressAdapter = AddressAdapter(FattyApp.getInstance()) { data, str, pos ->
            when (str) {
                ...
                "update" -> viewModel.updateCurrentAddress(data.customer_address_id,data.customer_id,data.address_latitude,data.address_longitude,data.current_address,data.customer_phone?: "",data.building_system?:"",data.address_type)
            }
        }
