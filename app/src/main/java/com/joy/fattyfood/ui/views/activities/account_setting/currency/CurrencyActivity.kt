package com.joy.fattyfood.ui.views.activities.account_setting.currency
...
import com.joy.fattyfood.adapters.CurrencyAdapter
import com.joy.fattyfood.app.FattyApp
import com.joy.fattyfood.databinding.ActivityCurrencyBinding
...
class CurrencyActivity : AppCompatActivity() {
    ...
    private fun render(state : com.joy.fattyfood.domain.viewstates.AboutViewState) {
        when(state) {
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnFailCurrency -> {
                renderError(state)
            }
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnSuccessCurrency -> {
    ...
    private fun renderError(state: com.joy.fattyfood.domain.viewstates.AboutViewState.OnFailCurrency) {
        CustomToast(this,state.message,false).createCustomToast()
    }

    private fun renderSucessCurrency(state : com.joy.fattyfood.domain.viewstates.AboutViewState.OnSuccessCurrency) {
