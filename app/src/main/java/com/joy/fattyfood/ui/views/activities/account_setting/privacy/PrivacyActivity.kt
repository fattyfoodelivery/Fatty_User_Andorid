package com.joy.fattyfood.ui.views.activities.account_setting.privacy
...
import com.joy.fattyfood.databinding.ActivityPrivacyBinding
...
class PrivacyActivity : AppCompatActivity() {
    ...
    private fun render(state : com.joy.fattyfood.domain.viewstates.AboutViewState) {
        when(state) {
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnLoadingPrivacyPolicy -> {

            }
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnSuccessPrivacyPolicy -> renderSuccess(state)
