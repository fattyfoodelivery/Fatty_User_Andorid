...
import com.joy.fattyfood.adapters.FoodOrderAdapter
import com.joy.fattyfood.adapters.PaymentMethodAdapter
import com.joy.fattyfood.app.FattyApp
import com.joy.fattyfood.databinding.ActivityCheckOutBinding
import com.joy.fattyfood.databinding.LayoutDialogRemoveCartBinding
import com.joy.fattyfood.domain.model.CreateFoodOrderVO
...
import com.joy.fattyfood.ui.views.activities.account_setting.manage_address.AddressPickUpMapBoxActivity
...
import com.joy.fattyfood.ui.views.fragments.HomeFragment
import com.joy.fattyfood.utils.ConfirmAddressDialog
...
import com.joy.fattyfood.utils.SHA
...
class CheckOutActivity : AppCompatActivity(), EmptyViewPodDelegate {
    ...
    private fun bindOrderInfo(data: KPayResponseVO) {
        ...
        sign = SHA.getSHA256Str("$orderInfo&key=$signKey")
    }
