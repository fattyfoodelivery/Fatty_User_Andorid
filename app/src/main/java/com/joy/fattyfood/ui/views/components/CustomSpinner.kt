package com.joy.fattyfood.ui.views.components
...
class CustomSpinner : AppCompatSpinner {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr:Int,mode: Int,popupTheme : Theme) : super(context, attrs, defStyleAttr,mode, popupTheme) {
