package com.joy.fattyfood.ui.views.activities.parcel
...
import com.joy.fattyfood.databinding.ActivityParcelDetailBinding
import com.joy.fattyfood.domain.model.ActiveOrderVO
import com.joy.fattyfood.domain.model.OrderStatusVO
import com.joy.fattyfood.domain.model.RatingDetailVO
...
import com.joy.fattyfood.domain.viewstates.TrackParcelViewState
...
import com.joy.fattyfood.utils.helper.toDefaultStatusName
...
class ParcelDetailActivity : AppCompatActivity() {
    ...
    private fun bindCheckParcelInfo(data : ActiveOrderVO) {
        ...
        binding.tvOrderId.text = "${"Order ID "}: ${data.order_id}"
