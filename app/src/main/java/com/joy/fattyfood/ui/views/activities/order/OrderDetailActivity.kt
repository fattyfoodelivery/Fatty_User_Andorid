package com.joy.fattyfood.ui.views.activities.order
...
import com.joy.fattyfood.adapters.OrderInfoAdapter
import com.joy.fattyfood.app.FattyApp
import com.joy.fattyfood.databinding.ActivityOrderDetailBinding
...
class OrderDetailActivity : AppCompatActivity() {
    ...
    private fun bindOrderDetailInfo(data: ActiveOrderVO) {
        binding.tvOrderId.text = resources.getString(R.string.order_id_4).plus(" ").plus(data.order_id)
