package com.joy.fattyfood.ui.views.activities.noti_detail
...
import com.joy.fattyfood.databinding.ActivityNotificationDetailBinding
import com.joy.fattyfood.domain.responses.SystemNotificationVO
import com.joy.fattyfood.domain.view_model.NotiViewModel
import com.joy.fattyfood.ui.views.activities.auth.login.LoginActivity
import com.joy.fattyfood.ui.views.fragments.NotiFragment
...
class NotificationDetailActivity : AppCompatActivity() {
    ...
    companion object {
        const val NOTI_ID = "sys_noti_id"
        const val NOTI_BODY = "sys_bodt"
    }
    ...
    private fun render(state : com.joy.fattyfood.domain.viewstates.InboxViewState) {
        when(state) {
            is com.joy.fattyfood.domain.viewstates.InboxViewState.OnLoadingSystemNotiList -> renderOnLoadingSystemNotiList()
            is com.joy.fattyfood.domain.viewstates.InboxViewState.OnSuccessSystemNotiList -> renderOnSuccessSystemNotiList(state)
            is com.joy.fattyfood.domain.viewstates.InboxViewState.OnFailSystemNotiList -> renderOnFailSystemNotiList(state)
            else -> {}
        }
    }
    ...
    private fun renderOnSuccessSystemNotiList(state: com.joy.fattyfood.domain.viewstates.InboxViewState.OnSuccessSystemNotiList) {
    ...
    private fun renderOnFailSystemNotiList(state: com.joy.fattyfood.domain.viewstates.InboxViewState.OnFailSystemNotiList) {
        LoadingProgressDialog.hideLoadingProgress()
        when(state.message){
