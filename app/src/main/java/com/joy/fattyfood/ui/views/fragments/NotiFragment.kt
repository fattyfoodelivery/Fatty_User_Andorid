...
import com.joy.fattyfood.adapters.NotiAdapter
import com.joy.fattyfood.adapters.SysNotiAdapter
import com.joy.fattyfood.app.FattyApp
import com.joy.fattyfood.databinding.FragmentNotiBinding
...
import com.joy.fattyfood.ui.views.activities.noti_detail.NotificationDetailActivity
...
class NotiFragment : Fragment(), ItemIdDelegate {
    ...
    private fun changeDateFormat(date: String) {
        ...
        try {
            ...
            filterDate = outputFormat.format(parsedDate!!)
