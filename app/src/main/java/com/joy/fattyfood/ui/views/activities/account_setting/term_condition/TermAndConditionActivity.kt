package com.joy.fattyfood.ui.views.activities.account_setting.term_condition
...
import com.joy.fattyfood.databinding.ActivityTermAndConditionBinding
...
class  TermAndConditionActivity : AppCompatActivity() {
    ...
    private fun render(state : com.joy.fattyfood.domain.viewstates.AboutViewState) {
        when(state) {
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnLoadingTermCondition -> {
                renderLoading()
            }
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnSuccessTermCondition -> {
                renderSuccess(state)
            }
            is com.joy.fattyfood.domain.viewstates.AboutViewState.OnFailTermCondition -> {
                renderError()
            }
            else -> {}
        }
    ...
    private fun renderSuccess(state: com.joy.fattyfood.domain.viewstates.AboutViewState.OnSuccessTermCondition) {
