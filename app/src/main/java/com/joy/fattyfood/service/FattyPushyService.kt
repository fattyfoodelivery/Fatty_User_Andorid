...
import com.joy.fattyfood.ui.views.activities.track.TrackOrderFoodActivity
import com.joy.fattyfood.ui.views.activities.track.TrackOrderMapBoxActivity
import com.joy.fattyfood.ui.views.activities.track.TrackOrderParcelActivity
import com.joy.fattyfood.ui.views.activities.track.TrackParcelOrderMapBoxActivity
            ...
            "food" -> {
                orderTypeIntent = when (type) {
                    "new_order" -> {
                        ...
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"new_order")
                            intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                            intent
                        } else {
                            // map view
                    ...
                    "restaurant_accept_order"  -> {
                        ...
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"restaurant_accept_order")
                            intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                            intent
                        } else {
                            val intent = Intent(this, TrackOrderMapBoxActivity::class.java)
                            intent.putExtra(TrackOrderMapBoxActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackOrderMapBoxActivity.IS_UPDATE_RIDER, false)
                            intent
                        }
                    }
                    ...
                    "rider_accept_order" -> {
                        ...
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"rider_accept_order")
                            intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                            intent
                        } else {
                            val intent = Intent(this, TrackOrderMapBoxActivity::class.java)
                    ...
                    "ready_pickup_order" -> {
                        ...
                        val intent = Intent(this, TrackOrderFoodActivity::class.java)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"ready_pickup_order")
                        intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                    ...
                    "rider_arrived" -> {
                        ...
                        val intent = Intent(this, TrackOrderFoodActivity::class.java)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"rider_arrived")
                        intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                    ...
                    "rider_start_delivery" -> {
                        ...
                        val intent = Intent(this, TrackOrderFoodActivity::class.java)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderFoodActivity.ORDER_STATUS,"rider_start_delivery")
                        intent.putExtra(TrackOrderFoodActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderFoodActivity::class.java)
                ...
                orderTypeIntent = when (type) {
                    "new_order" -> {
                        ...
                        if (checkService() == 0) {
                            ...
                            intent.putExtra(TrackOrderParcelActivity.ORDER_STATUS, "new_order")
                            intent.putExtra(TrackOrderParcelActivity.IS_UPDATE_RIDER, false)
                            intent
                        } else {
                            val intent = Intent(this, TrackParcelOrderMapBoxActivity::class.java)
                            intent.putExtra(TrackParcelOrderMapBoxActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackParcelOrderMapBoxActivity.IS_UPDATE_RIDER, false)
                            intent
                        }
                    }
                    ...
                    "rider_accept_parcel_order" -> {
                        ...
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderParcelActivity::class.java)
                            intent.putExtra(TrackOrderParcelActivity.ORDER_ID, orderId)
                            intent.putExtra(TrackOrderParcelActivity.ORDER_STATUS, "rider_accept_parcel_order")
                            intent.putExtra(TrackOrderParcelActivity.IS_UPDATE_RIDER, false)
                            intent
                        } else {
                            val intent = Intent(this, TrackParcelOrderMapBoxActivity::class.java)
                    ...
                    "rider_arrived_pickup_address" -> {
                        ...
                        val intent = Intent(this, TrackOrderParcelActivity::class.java)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_STATUS, "rider_arrived_pickup_address")
                        intent.putExtra(TrackOrderParcelActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderParcelActivity::class.java)
                    ...
                    "rider_start_delivery_parcel" -> {
                        ...
                        val intent = Intent(this, TrackOrderParcelActivity::class.java)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_STATUS, "rider_start_delivery_parcel")
                        intent.putExtra(TrackOrderParcelActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderParcelActivity::class.java)
                    ...
                    "rider_parcel_update" -> {
                        ...
                        val intent = Intent(this, TrackOrderParcelActivity::class.java)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_ID, orderId)
                        intent.putExtra(TrackOrderParcelActivity.ORDER_STATUS,  "rider_parcel_update")
                        intent.putExtra(TrackOrderParcelActivity.IS_UPDATE_RIDER, false)
                        intent
                        if (checkService() == 0) {
                            val intent = Intent(this, TrackOrderParcelActivity::class.java)
