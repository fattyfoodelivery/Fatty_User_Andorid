...
import com.joy.fattyfood.data.apiService.AddressService
...
class AddressRepositoryImpl @Inject constructor(
    ...
    override suspend fun addCurrentAddress(
        ...
        address_type: String
    ): Response<CustomerAddressResponse>  = addressService.addCurrentAddress(customer_id, address_latitude, address_longitude, current_address, customer_phone, building_system, address_type)
    ...
    override suspend fun updateCurrentAddress(
        ...
        building_system: String,
        address_type: String
    ): Response<CustomerAddressResponse> = addressService.updateCurrentAddress(customer_address_id, customer_id, address_latitude, address_longitude, current_address, customer_phone, building_system, address_type)
