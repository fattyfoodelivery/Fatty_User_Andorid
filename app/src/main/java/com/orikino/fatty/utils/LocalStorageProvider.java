...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        //row.add(Root.COLUMN_ICON, R.drawable.ic_bookmark);
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        // Assume documentId points to an image file. Build a placeholder no
        ...
        // Write out the placeholder to a temporary file
        File tempFile = null;
        FileOutputStream out = null;
        try {
            tempFile = File.createTempFile("placeholder", null, getContext().getCacheDir());
            out = new FileOutputStream(tempFile);
            bitmap.compress(Bitmap.CompressFormat.PNG, 90, out);
        } catch (IOException e) {
            Log.e(LocalStorageProvider.class.getSimpleName(), "Error writing placeholder", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageProvider.class.getSimpleName(), "Error closing placeholder", e);
                }
        }
