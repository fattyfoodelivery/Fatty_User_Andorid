...
/*
class OptionAddFoodAdapter(var binding : ItemTopFoodCategoryBinding,val onSelectItem : (data : OptionVO, foodSubItemId : Int, isRequire : Int)-> Unit) : BaseViewHolder<>(binding.root) {
    */
/*fun bindView(item : CategoVO) {
