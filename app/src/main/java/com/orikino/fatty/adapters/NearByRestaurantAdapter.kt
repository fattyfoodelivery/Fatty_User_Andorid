...
class NearByRestaurantAdapter(context: Context, private val imageUrlProvider: ImageUrlProvider, private var callback: (NearByRestaurantVO,String,Int) -> Unit) : BaseAdapter<NearRestaurantViewHolder, NearByRestaurantVO>(context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<NearByRestaurantVO> {
        ...
        return NearRestaurantViewHolder(binding,imageUrlProvider,callback)
    }
}