...
class RecommendedRestaurantAdapter(context: Context,private val imageUrlProvider: ImageUrlProvider,private var callback : (RecommendRestaurantVO,String,Int) -> Unit) : BaseAdapter<RecommendedRestaurantsViewHolder, RecommendRestaurantVO>(context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<RecommendRestaurantVO> {
        ...
        return RecommendedRestaurantsViewHolder(binding,imageUrlProvider,callback)
    }
}