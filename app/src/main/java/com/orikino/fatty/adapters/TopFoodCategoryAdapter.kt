...
class TopFoodCategoryAdapter(context: Context, private val imageUrlProvider: ImageUrlProvider, private var callbacks: (CategoryVO) -> Unit) : BaseAdapter<TopFoodCategoryViewHolder, CategoryVO>(context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<CategoryVO> {
        ...
        return TopFoodCategoryViewHolder(binding,imageUrlProvider,callbacks)
    }
