...
class PlayerGuideAdapter(context: Context, private val imageUrlProvider: ImageUrlProvider, private var delegate: ItemStringDelegate) : BaseAdapter<PlayGuideViewHolder, TutorialVO>(context){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<TutorialVO> {
        ...
        return PlayGuideViewHolder(binding,imageUrlProvider,delegate)
    }
}