package com.orikino.fatty.ui.views.activities.account_setting.about
...
class AboutUsActivity : AppCompatActivity() {
    ...
    private fun render(state : com.orikino.fatty.domain.viewstates.AboutViewState) {
        when(state) {
            is com.orikino.fatty.domain.viewstates.AboutViewState.OnLoadingAbout -> {
                renderLoading()
            }
            is com.orikino.fatty.domain.viewstates.AboutViewState.OnSuccessAbout -> {
                renderSuccess(state)
            }
            is com.orikino.fatty.domain.viewstates.AboutViewState.OnFailAbout -> {
                renderFail()
            }
            else -> {}
